...
class VideoPlayerNetworks extends StatefulWidget {
  @override
  _VideoPlayerNetworksState createState() => _VideoPlayerNetworksState();
}

class _VideoPlayerNetworksState extends State<VideoPlayerNetworks> {
